...
class UserOrganizationsControllerTest < ActionController::TestCase
  ...
  test "should create user_organization" do
    assert_difference('UserOrganization.count') do
      post :create, user_organization: { end_date: @user_organization.end_date, organization_id_id: @user_organization.organization_id_id, start_date: @user_organization.start_date, user_id_id: @user_organization.user_id_id }
    end
  ...
  test "should update user_organization" do
    patch :update, id: @user_organization, user_organization: { end_date: @user_organization.end_date, organization_id_id: @user_organization.organization_id_id, start_date: @user_organization.start_date, user_id_id: @user_organization.user_id_id }
    assert_redirected_to user_organization_path(assigns(:user_organization))
  end
